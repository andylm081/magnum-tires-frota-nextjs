...
import UserMenu from './UserMenu'; // Importa o componente UserMenu real
...
const IconMultas = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M9,4H15V12H9V4M11,6V10H13V6H11M12,14A2,2 0 0,0 10,16A2,2 0 0,0 12,18A2,2 0 0,0 14,16A2,2 0 0,0 12,14M6,2L3,5V20A2,2 0 0,0 5,22H19A2,2 0 0,0 21,20V5L18,2H6Z" />
  </svg>
);
...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  if (isAuthRoute) {
    return <main className="app-container" style={{ justifyContent: 'center', alignItems: 'center' }}>{children}</main>;
  }
